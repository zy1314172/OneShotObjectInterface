...
class Iwindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.origin_pic.setFont(font)
        self.origin_pic.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.origin_pic.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.origin_pic.setAutoFillBackground(False)
        self.origin_pic.setStyleSheet("background-color: white; /* Blue */\n"
                                       "color:black;")
        self.origin_pic.setAutoDefault(False)
        self.origin_pic.setDefault(False)
        self.origin_pic.setFlat(False)
        self.origin_pic.setObjectName("origin_pic")
        self.verticalLayout_10.addWidget(self.origin_pic)
        self.target_pic = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.target_pic.setFont(font)
        self.target_pic.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.target_pic.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.target_pic.setAutoFillBackground(False)
        self.target_pic.setStyleSheet("background-color: white; /* Blue */\n"
                                      "color:black;")
        self.target_pic.setAutoDefault(False)
        self.target_pic.setDefault(False)
        self.target_pic.setFlat(False)
        self.target_pic.setObjectName("origin_pic")
        self.verticalLayout_10.addWidget(self.target_pic)
        ...
        self.label_4.setStyleSheet("background-color:black;color:white;padding:5px")
