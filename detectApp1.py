...
class Ui_Detect_App(object):
    def setupUi(self, DetectApp):
        ...
        self.amplification_button.setGeometry(QtCore.QRect(810, 260, 75, 23))
        ...
        self.narrow_button.setGeometry(QtCore.QRect(810, 300, 75, 23))
        ...
        self.rect_button.setGeometry(QtCore.QRect(810, 340, 75, 23))
        ...
        self.rect_button.clicked.connect(self.controlDetect)
    ...
    def retranslateUi(self, DetectApp):
        ...
        self.rect_button.setText(_translate("DetectApp", "开始识别"))
    ...
    def showSmallPic(self,):
        ...
        for path in self.picList[self.curIndex]:
            jpg = QtGui.QPixmap(path).scaled(80, 80)
            if index == 1:
                self.label_1.setPixmap(jpg)
            elif index == 2:
                self.label_2.setPixmap(jpg)
    ...
    def showBigPic(self, path):
        ...
        # pix = QPixmap(result)
        pix = QPixmap(path).scaled(800, 600)
    ...
    def controlDetect(self):
        ...
        beishu = im.width / 800
        region = im.crop((self.bigPic.x0 * beishu, self.bigPic.y0 * beishu, self.bigPic.x1 * beishu, self.bigPic.y1 * beishu))
